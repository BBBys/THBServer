...
#
# @author Borys 11 Nov 14 Jul 2019 20 Nov 2018
#
...
## Ausgben, wenn True
Dbg=False
## bestimmt Wetteränderung aus Druck, Jahreszeit und Druckänderung. Gibt Name des Icons zurück, welches die Ändrung darstellt, 
# in einigen Fällen auch Text, der die Änderung beschreibt.
# @todo Icons für restliche Texte entwerfen
# @param p Druck in hPa
# @param dp Druckänderung in hPa/h
# @param pjetzt nicht verwendet
# @returns String "<Text über bevorstehende Änderung>" oder "B=<Icon>"
